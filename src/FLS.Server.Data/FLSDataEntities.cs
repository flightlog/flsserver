...
namespace FLS.Server.Data
{
    public partial class FLSDataEntities : TrackerContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Flight>().Ignore(t => t.IsSelfStartFlight);
            modelBuilder.Entity<Flight>().Ignore(t => t.Duration);
            modelBuilder.Entity<Flight>().Ignore(t => t.StartDate);
            modelBuilder.Entity<Flight>().Ignore(t => t.IsLanded);
            modelBuilder.Entity<Flight>().Ignore(t => t.FlightCrewCommaSeperated);
            modelBuilder.Entity<Flight>().Ignore(t => t.CanStart);
            modelBuilder.Entity<Flight>().Ignore(t => t.CanLand);
            modelBuilder.Entity<Flight>().Ignore(t => t.IsInstructorRequired);
            modelBuilder.Entity<Flight>().Ignore(t => t.CanHavePassenger);
            modelBuilder.Entity<Flight>().Ignore(t => t.CanHaveTwoPilots);
            modelBuilder.Entity<Flight>().Ignore(t => t.HasStartLocationShortName);
            modelBuilder.Entity<Flight>().Ignore(t => t.HasLdgLocationShortName);
            modelBuilder.Entity<Flight>().Ignore(t => t.HasStartLocationIcaoCode);
            modelBuilder.Entity<Flight>().Ignore(t => t.FlightsLongerThanOneDay);
            modelBuilder.Entity<Flight>().Ignore(t => t.HasLdgLocationIcaoCode);
