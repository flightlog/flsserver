...
{
    public partial class InvoiceRuleFilterType
    {
        public InvoiceRuleFilterType()
        {
        ...
        [Required]
        [StringLength(50)]
        public string InvoiceRuleFilterTypeName { get; set; }

        public string InvoiceRuleFilterTypeKeyName { get; set; }
