...
{
    public partial class InvoiceRuleFilter : IFLSMetaData
    {
        ...
        public string AircraftImmatriculations { get; set; }
        ...
        public virtual InvoiceRuleFilterType InvoiceRuleFilterType { get; set; }
