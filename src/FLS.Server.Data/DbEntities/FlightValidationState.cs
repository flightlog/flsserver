...
{
    public partial class FlightValidationState
    {
        public FlightValidationState()
        {
            Flights = new HashSet<Flight>();
        }

        [Required]
        public int FlightValidationStateId { get; set; }

        [Required]
        [StringLength(50)]
        public string FlightValidationStateName { get; set; }
