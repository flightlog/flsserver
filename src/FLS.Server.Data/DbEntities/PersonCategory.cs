...
{
    public partial class PersonCategory : IFLSMetaData
    {
        public PersonCategory()
        {
            ChildPersonCategories = new HashSet<PersonCategory>();
        ...
        public Guid? ParentPersonCategoryId { get; set; }
        ...
        public virtual ICollection<PersonCategory> ChildPersonCategories { get; set; }

        public virtual PersonCategory ParentPersonCategory { get; set; }
