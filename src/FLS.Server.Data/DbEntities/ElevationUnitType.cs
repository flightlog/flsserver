...
{
    public partial class ElevationUnitType
    {
        public ElevationUnitType()
        {
        ...
        [Required]
        [StringLength(50)]
        public string ElevationUnitTypeName { get; set; }

        [Required]
        [StringLength(50)]
        public string ElevationUnitTypeKeyName { get; set; }

        [StringLength(20)]
        public string ElevationUnitTypeShortName { get; set; }
