...
{
    internal abstract class BaseInvoiceLineRule : BaseRule<RuleBasedFlightInvoiceDetails>
    {
        private readonly Flight _flight;
        private readonly BaseRuleFilter _invoiceLineRuleFilter;

        protected Flight Flight { get { return _flight; } }
        protected BaseRuleFilter BaseInvoiceLineRuleFilter { get { return _invoiceLineRuleFilter; } }
        internal BaseInvoiceLineRule(Flight flight, BaseRuleFilter invoiceLineRuleFilter)
        {
            _flight = flight;
