...
CREATE TABLE [dbo].[DeliveryCreationTests](
	...
	[ExpectedDeliveryDetails] [nvarchar](max) NULL,
	[ExpectedMatchedAccountingRuleFilterIds] [nvarchar](max) NULL,
	[MustNotCreateDeliveryForFlight] [bit] NOT NULL CONSTRAINT [DF__DeliveryCreationTests__MustNotCreateDeliveryForFlight]  DEFAULT ((0)),
	...
	[IgnoreRecipientPersonId] [bit] NOT NULL CONSTRAINT [DF__DeliveryCreationTests__IgnoreRecipientPersonId]  DEFAULT ((0)),
	[IgnoreRecipientClubMemberNumber] [bit] NOT NULL CONSTRAINT [DF__DeliveryCreationTests__IgnoreRecipientClubMemberNumber]  DEFAULT ((0)),
	...
	[LastTestResultMessage] [nvarchar](max) NULL,
	[LastTestCreatedDeliveryDetails] [nvarchar](max) NULL,
	[LastTestMatchedAccountingRuleFilterIds] [nvarchar](max) NULL,
