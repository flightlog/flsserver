...
[RecipientZip] = (SELECT REPLACE(SUBSTRING([RecipientDetails], CHARINDEX('ZipCode":',[RecipientDetails],0)+9, CHARINDEX(',"City":',[RecipientDetails],0) - CHARINDEX('ZipCode":',[RecipientDetails],0)-9), '"','')),
