...
SET @personId = NEWID()
INSERT INTO Persons (PersonId, Lastname, Firstname, AddressLine1, Zip, City, PrivatePhone, BusinessPhone, MobilePhone, EmailPrivate, HasMotorPilotLicence, HasTowPilotLicence, HasGliderInstructorLicence, HasGliderPilotLicence, HasGliderTraineeLicence, CountryId, CreatedOn, CreatedByUserId, RecordState, OwnerId, OwnershipType, IsFastEntryRecord) VALUES (@personId, 'Baeri', 'Jürgi', 'Stuketenstrasse 14', '8332', 'Rumlikon', '044 950 00 00', '', '079 999 99 99', 'juergi.baeri@bluewin.ch',1, 1, 1, 1, 0, @SwitzerlandId, SYSDATETIME(), @insertUserId, @recordState, @ownerId, @OwnershipType, 0)
INSERT INTO PersonClub (PersonId, ClubId, MemberNumber, IsMotorPilot, IsTowPilot, IsGliderInstructor, IsGliderPilot, IsGliderTrainee, CreatedOn, CreatedByUserId, RecordState, OwnerId, OwnershipType, IsPassenger, IsWinchOperator) VALUES (@personId, @insertClubId, '987654', 1, 1, 1, 1, 0, SYSDATETIME(), @insertUserId, @recordState, @ownerId, @OwnershipType, 0, 0)
SET @personId = NEWID()
INSERT INTO Persons (PersonId, Lastname, Firstname, AddressLine1, Zip, City, PrivatePhone, BusinessPhone, MobilePhone, EmailPrivate, HasMotorPilotLicence, HasTowPilotLicence, HasGliderInstructorLicence, HasGliderPilotLicence, HasGliderTraineeLicence, CountryId, CreatedOn, CreatedByUserId, RecordState, OwnerId, OwnershipType, IsFastEntryRecord) VALUES (@personId, 'Zimmermannli', 'Ursli', 'Schützenweg 4', '9000', 'St. Gallen', '052 444 44 55', '', '079 8759987', 'ursli@bluewin.ch;',0, 0, 0, 1, 0, @SwitzerlandId, SYSDATETIME(), @insertUserId, @recordState, @ownerId, @OwnershipType, 0)
INSERT INTO PersonClub (PersonId, ClubId, MemberNumber, IsMotorPilot, IsTowPilot, IsGliderInstructor, IsGliderPilot, IsGliderTrainee, CreatedOn, CreatedByUserId, RecordState, OwnerId, OwnershipType, IsPassenger, IsWinchOperator) VALUES (@personId, @insertClubId, '786646', 0, 0, 0, 1, 0, SYSDATETIME(), @insertUserId, @recordState, @ownerId, @OwnershipType, 0, 0)
