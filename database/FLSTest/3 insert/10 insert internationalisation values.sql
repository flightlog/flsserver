...
INSERT INTO [dbo].[LanguageTranslations] ([LanguageTranslationId], [TranslationKey], [TranslationValue], [LanguageId], [CreatedOn], [CreatedByUserId], [RecordState], [OwnerId], [OwnershipType], [IsDeleted]) 
     VALUES (NEWID(), 'NO_MEDICAL_INFO', 'Hier w�rde das Ablaufdatum des Medicals angezeigt werden. Das Datum kann unter folgendem Link ganz einfach in der Rubrik "Lizenz" erfasst werden:', 1, SYSDATETIME(), @insertUserId, 1, @ownerId, @OwnerShipType, 0)
...
INSERT INTO [dbo].[LanguageTranslations] ([LanguageTranslationId], [TranslationKey], [TranslationValue], [LanguageId], [CreatedOn], [CreatedByUserId], [RecordState], [OwnerId], [OwnershipType], [IsDeleted]) 
     VALUES (NEWID(), 'FILTER_PERSON_FLAG_HasGliderTraineeLicence', 'Segelflug Sch�ler', 1, SYSDATETIME(), @insertUserId, 1, @ownerId, @OwnerShipType, 0)
...
INSERT INTO [dbo].[LanguageTranslations] ([LanguageTranslationId], [TranslationKey], [TranslationValue], [LanguageId], [CreatedOn], [CreatedByUserId], [RecordState], [OwnerId], [OwnershipType], [IsDeleted]) 
     VALUES (NEWID(), 'FLIGHT_COUNTER_UNIT_TYPE', 'Flug Z�hler Einheit', 1, SYSDATETIME(), @insertUserId, 1, @ownerId, @OwnerShipType, 0)

INSERT INTO [dbo].[LanguageTranslations] ([LanguageTranslationId], [TranslationKey], [TranslationValue], [LanguageId], [CreatedOn], [CreatedByUserId], [RecordState], [OwnerId], [OwnershipType], [IsDeleted]) 
     VALUES (NEWID(), 'ENGINE_COUNTER_UNIT_TYPE', 'Motor Z�hler Einheit', 1, SYSDATETIME(), @insertUserId, 1, @ownerId, @OwnerShipType, 0)
